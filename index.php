...
fbq('init', '720763551912239');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=720763551912239&ev=PageView&noscript=1"
/></noscript>
...
<head>
   ...
   ================================================== -->
    <meta charset="utf-8">
    <title>B&R Paradise Sip and Munch</title>
    <meta name="description" content="">
    <meta name="author" content="">
    <meta name="description" content="Order Online for Takeaway / Pickup. Here at B&R Paradise Sip And Munch - Manila City you'll experience delicious Coffee, Fast Food, Milktea cuisine. Try our mouth-watering dishes, carefully prepared with fresh ingredients! At B&R Paradise Sip And Munch, our recipe for success is simple – Great food & care makes customers return every time.">
...
<body id="top">
   ...
   <header id="header" class="row">   
        ...
        <div class="header-logo">
            <a href="index.php">B&R Paradise</a>
        </div>
        ...
        <nav id="header-nav-wrap">
            ...
            <a href="https://tasa.brparadisesipandmunch.com/"  target="_blank" class="button button-primary cta tasa_btn">Tasa Coffee and Tea
            <img class="coffee" src="images/coffee.png" style="position:absolute; top:20%; width:8%; left:100%; display:none;">
            </a>
   ...
   <section id="home" data-parallax="scroll" data-image-src="images/brparadise-sketch.jpg" data-natural-width=3000 data-natural-height=2000>
            ...
            <div class="row contents">                     
                <div class="home-content-left">
                    ...
                    <h1 data-aos="fade-up">
                        ...
                        <a href="https://www.adminfoodbooking.com/ordering/restaurant/menu?company_uid=468488dd-f3f8-4f41-a47c-adccd251169a&restaurant_uid=150d2326-c5fb-46d0-bfa4-114d22877ba0&facebook=true&fbclid=IwAR1HEOJ-69ce0svOWVhpQH-NLISS8lt6wPjiZR7yFwmGusB0gpIFS2UAj30" target="_blank" class="button stroke" style="z-index:9999999999999px;">
        ...
        <div class="row about-intro">
            ...
            <div class="col-six">
                ...
                <p class="lead" data-aos="fade-up">
                    B&R Paradise is a start up business in Manila, Philippines. Established on February 2020 by B&R Paraiso. Originally serving only milktea drinks but now expands into serving coffee and frappe drinks. We also offer munchables such as nachos, fries, mojos and chicken. We not only offer you with your favorite sip and munch but we also give you a paradisiacal experience. 

                    <br/></br>Make your tummy happy with us. For special occassions or requests, you may contact us via email or social media apps.
                </p>
            </div>                       
            ...
            <div class="about-how-content" data-aos="fade-up">
                <div class="about-how-steps block-1-2 block-tab-full group">
                    ...
                    <div class="bgrid step" data-item="3">
                        <h3>Fill Up Form</h3>
                        <p>Make sure to fill up contact correctly. We will contact you to confirm your order via text or call. We accept payment via bank transfer and gcash.
                        </p> 
                    </div>
    ...
    <section id="testimonials">
        ...
        <div class="row">
            <div class="col-twelve">
                <h1 class="intro-header" data-aos="fade-up" style="color:black;">What They Say About Us</h1>
            </div>          
        </div>      
        ...
        <div class="row owl-wrap">
            ...
            <div id="testimonial-slider"  data-aos="fade-up">
                ...
                <div class="slides owl-carousel">
                    <div>
                        <p>
                        Masarap ang milktea at nachos as always!
                        </p> 
                        <center><img src="images/star.png" class="star"></center>
                        <div class="testimonial-author">
                                <!--img src="images/avatars/user-02.jpg" alt="Author image"=-->
                                <div class="author-info">
                                    Irah
                                    <span class="position">Foodpanda App</span>
                                </div>
                        </div>                 
                    </div>
                    <div>
                        <p>
                        Good job po!the nachos is truly an overloaded one:)madame po ang servings and thank u so much for that:)
                        </p> 
                        <center><img src="images/star.png" class="star"></center>
                        <div class="testimonial-author">
                                <!--img src="images/avatars/user-02.jpg" alt="Author image"=-->
                    ...
                    <div>
                        <p>
                        Superb food accommodating seller recommended 101%
                        </p> 
                        <center><img src="images/star.png" class="star"></center>
                        <div class="testimonial-author">
                                <!--img src="images/avatars/user-02.jpg" alt="Author image"=-->
                    ...
                    <div>
                        <p>
                        Super sarap and hindi tinipid lahat ng food nila and milktea as well.
                        </p> 
                        <center><img src="images/star.png" class="star"></center>
                        <div class="testimonial-author">
                                <!--img src="images/avatars/user-02.jpg" alt="Author image"=-->
                    ...
                    <div>
                        <p>
                        Highly recommendable! Keep it up! God bless!
                        </p> 
                        <center><img src="images/star.png" class="star"></center>
                        <div class="testimonial-author">
                                <!--img src="images/avatars/user-02.jpg" alt="Author image"=-->
                    ...
                    <div>
                        <p>
                        very masarap, definitely will order again next time
                        </p> 
                        <center><img src="images/star.png" class="star"></center>
                        <div class="testimonial-author">
                                <!--img src="images/avatars/user-02.jpg" alt="Author image"=-->
                    ...
                    <div>
                        <p>
                        Sarap lahat! Very generous servings.
                        </p> 
                        <center><img src="images/star.png" class="star"></center>
                        <div class="testimonial-author">
                                <!--img src="images/avatars/user-02.jpg" alt="Author image"=-->
                    ...
                    <div>
                        <p>
                        Best Milk Tea shop in town. I will order again soon.
                        </p> 
                        <center><img src="images/star.png" class="star"></center>
                        <div class="testimonial-author">
                                <!--img src="images/avatars/user-02.jpg" alt="Author image"=-->
                                <div class="author-info">
                                    Maria Theresa
                                    <span class="position">Foodpanda Customer</span>
                                </div>
                        </div>                 
                    </div>  
            ...
            <div class="row">  
                ...
                <div class="col-three md-1-3 tab-full footer-info">            
                    ...
                    <p>
                        ...
                        <br/><br/>
                        So whether you eat or drink or whatever you do, do it all for the glory of God. <br/>1 Corinthians 10:31
                    </p>
                ...
                <div class="col-two md-1-3 tab-1-2 mob-full footer-site-links">
                    ...
                    <ul class="list-links">
                        ...
                        <li><a href="https://tasa.brparadisesipandmunch.com/" target="_blank">Tasa Coffee and Tea</a></li>
    ...
    <script>
    $( ".tasa_btn" ).mouseenter(function() {
      $(".coffee").fadeIn( 500 );
    });

    $( ".tasa_btn" ).mouseleave(function() {
      $(".coffee").fadeOut( 500 );
    });
